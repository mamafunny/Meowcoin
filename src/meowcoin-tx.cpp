...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s meowcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  meowcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded meowcoin transaction") + "\n" +
              "  meowcoin-tx [options] -create [commands]   " + _("Create hex-encoded meowcoin transaction") + "\n" +
              "\n";
