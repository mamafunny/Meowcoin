...
//        m_toolbar->addAction(votingAction);
        ...
        labelVersionUpdate->setText("<a href=\"https://github.com/RavenProject/Meowcoin/releases\">New Wallet Version Available</a>");
                       ...
                       if (key == "tag_name") {
                           ...
                           if (fNewSoftwareFound) {
                               ...
                               if (GetRandInt(2) == 1) {
                                   ...
                                   if (fRet) {
                                       QString link = "https://github.com/RavenProject/Meowcoin/releases";
...
{
    versionRequest->setUrl(QUrl("https://api.github.com/repos/RavenProject/Meowcoin/releases"));
