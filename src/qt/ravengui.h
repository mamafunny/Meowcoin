...
/**
  Meow GUI main class. This class represents the main window of the Meow UI. It communicates with both the client and
...
public:
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a meow wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
