...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatMeowURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + MeowUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatMeowURI(info));
}
