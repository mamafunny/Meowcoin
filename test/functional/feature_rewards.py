...
class RewardsTest(MeowcoinTestFramework):
    ...
    # Basic functionality test - MEWC reward
    # - create the main owner address
    # - mine blocks to have enough MEWC for the reward payments, plus purchasing the asset
    ...
    def basic_test_mewc(self):
        ...
        n0.distributereward(asset_name="STOCK1", snapshot_height=tgt_block_height, distribution_asset_name="MEWC",
        ...
        self.log.info("Verifying MEWC holdings after payout")
    ...
    # - create the main owner address
    # - mine blocks to have enough MEWC for the reward fees, plus purchasing the asset
    ...
    def payout_without_snapshot(self):
        ...
        assert_raises_rpc_error(-32600, "Snapshot request not found",
                                n0.distributereward, "STOCK3", tgt_block_height, "MEWC", 2000, owner_addr0)
    ...
    def payout_with_invalid_ownership_asset(self):
        ...
        assert_raises_rpc_error(-32600, "The asset hasn't been created: STOCK4",
                                n0.distributereward, "STOCK4", tgt_block_height, "MEWC", 2000, owner_addr0)
    ...
    def payout_custom_height_set_with_low_funds(self):
        ...
        n1.distributereward("STOCK7", tgt_block_height, "MEWC", 2000, owner_addr0)

        n1.generate(2)
        self.sync_all()

        assert_equal(n1.getdistributestatus("STOCK7", tgt_block_height, "MEWC", 2000, owner_addr0)['Status'], 3)
