...
class TestMeowCli(MeowTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `meow-cli getinfo`")
        ...
        self.log.info("Compare responses from `meow-cli -getinfo` and the RPCs data is retrieved from.")
