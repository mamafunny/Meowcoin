...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the MeowTestFramework
    pass

class ExampleTest(MeowTestFramework):
    # Each functional test is a subclass of the MeowTestFramework class.
    ...
    def custom_method(self):
        ...
        MeowTestFramework class so other tests can use it."""
