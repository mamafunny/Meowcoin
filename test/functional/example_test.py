...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the MeowcoinTestFramework
    pass

class ExampleTest(MeowcoinTestFramework):
    # Each functional test is a subclass of the MeowcoinTestFramework class.
    ...
    def custom_method(self):
        ...
        MeowcoinTestFramework class so other tests can use it."""
