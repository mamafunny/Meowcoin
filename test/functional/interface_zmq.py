...
import os
import struct
from test_framework.test_framework import MeowTestFramework, SkipTest
...
# noinspection PyUnresolvedReferences
class ZMQTest(MeowTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that meow has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("meowd has not been built with zmq enabled.")
