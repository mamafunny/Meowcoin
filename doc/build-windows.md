...
Below are some notes on how to build Meow Core for Windows.
...
way. This will install to `c:\workspace\meow`, for example:

    make install DESTDIR=/mnt/c/workspace/meow
