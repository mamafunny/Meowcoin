...
* Update translations see [translation_process.md](https://github.com/MeowcoinProject/Meowcoin/blob/master/doc/translation_process.md#synchronising-translations).

* Update manpages, see [gen-manpages.sh](https://github.com/MeowcoinProject/Meowcoin/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
### First time / New builders
    ...
    git clone https://github.com/MeowcoinProject/Meowcoin.git
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/MeowcoinProject/Meowcoin/releases/new) with a link to the archived release notes.
