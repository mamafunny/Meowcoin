...
1. Clone the Meow Core source code:
    ```shell
...
## `disable-wallet` mode
When the intention is to run only a P2P node without a wallet, Meow Core may be
...
```shell
mkdir -p "/Users/${USER}/Library/Application Support/Meow"

touch "/Users/${USER}/Library/Application Support/Meow/meow.conf"

chmod 600 "/Users/${USER}/Library/Application Support/Meow/meow.conf"
```

The first time you run meowd, it will start downloading the blockchain. This process could
