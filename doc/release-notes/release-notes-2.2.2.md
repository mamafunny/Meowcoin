Meowcoin Core version *2.2.2* is now available!!
==============

  <https://github.com/MeowcoinProject/Meowcoin/releases/tag/v2.2.2>
...
Changelog available here: <https://github.com/MeowcoinProject/Meowcoin/commits/release_2.2.2>
