#!/usr/bin/env python3
# Script to issue assets on the Meowcoin platform
...
# Prerequisite: meowd daemon to be running
...
#Set this to your meow-cli program
cli = "meow-cli"
...
#mode =  "-regtest"
#rpc_port = 18443
csv_file = "Meow Assets - Sheet1.csv"
#Set this information in your meow.conf file (in datadir, not testnet3)
rpc_user = 'rpcuser'
rpc_pass = 'rpcpass555'
