...
sudo find ${DISTNAME}/bin -type f -executable -exec ../meowcoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
sudo find ${DISTNAME}/lib -type f -exec ../meowcoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
#transfer MacOSX10.11.sdk.tar.gz to the folder meowcoin/depends/SDKs
