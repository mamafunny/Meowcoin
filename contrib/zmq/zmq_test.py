...
while True:
	...
	if topic == b"hashblock":
		...
		while(pos != -1):
			...
			if (pos > -1):
				print("FOUND MEWC issuance at " + str(pos))
				print("After MEWC: " + astr[pos+6:pos+8])
			...
			pos = astr.find('72766e', start)
			if (pos > -1):
				print("FOUND MEWC something at " + str(pos))
			start += pos+8
			print(astr)
