...
EXCLUDE = [
    ...
    'src/secp256k1/src/java/org_meowcoin_NativeSecp256k1.c',
    'src/secp256k1/src/java/org_meowcoin_NativeSecp256k1.h',
    'src/secp256k1/src/java/org_meowcoin_Secp256k1Context.c',
    'src/secp256k1/src/java/org_meowcoin_Secp256k1Context.h',
    # auto generated:
...
EXPECTED_HOLDER_NAMES = [
    "Satoshi Nakamoto\n",
    "The Meowcoin Core developers\n",
    "The Meowcoin Core developers \n",
    "Meowcoin Core Developers\n",
    "the Meowcoin Core developers\n",
    "The Meowcoin developers\n",
